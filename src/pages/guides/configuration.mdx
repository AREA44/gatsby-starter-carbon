...
[plugin options](https://www.gatsbyjs.com/packages/gatsby-remark-images/#options).
...
provide your own
[resolvers object](https://www.gatsbyjs.com/packages/gatsby-plugin-lunr/#getting-started)
...
- `remarkPlugins` - An array containing
  [remark plugin configurations](https://www.gatsbyjs.com/packages/gatsby-plugin-mdx/#remark-plugins)
  to be added.
...
### Example [Gatsby Remark Mermaid plugin](https://www.gatsbyjs.com/packages/gatsby-remark-mermaid/)
